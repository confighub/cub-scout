...
For v2.12.0, use Homebrew, the `cub` plugin, or the published archives below.
...
For an existing installation: `cub plugin upgrade scout@v2.12.0`.
...
The [v2.12.0 release](https://github.com/confighub/cub-scout/releases/tag/v2.12.0)
contains six archives and [checksums.txt](https://github.com/confighub/cub-scout/releases/download/v2.12.0/checksums.txt).
Archive names include the version and use underscores, not hyphens:

| Platform | Archive |
|---|---|
| macOS Apple Silicon | [cub-scout_2.12.0_darwin_arm64.tar.gz](https://github.com/confighub/cub-scout/releases/download/v2.12.0/cub-scout_2.12.0_darwin_arm64.tar.gz) |
| macOS Intel | [cub-scout_2.12.0_darwin_amd64.tar.gz](https://github.com/confighub/cub-scout/releases/download/v2.12.0/cub-scout_2.12.0_darwin_amd64.tar.gz) |
| Linux arm64 | [cub-scout_2.12.0_linux_arm64.tar.gz](https://github.com/confighub/cub-scout/releases/download/v2.12.0/cub-scout_2.12.0_linux_arm64.tar.gz) |
| Linux amd64 | [cub-scout_2.12.0_linux_amd64.tar.gz](https://github.com/confighub/cub-scout/releases/download/v2.12.0/cub-scout_2.12.0_linux_amd64.tar.gz) |
| Windows arm64 | [cub-scout_2.12.0_windows_arm64.zip](https://github.com/confighub/cub-scout/releases/download/v2.12.0/cub-scout_2.12.0_windows_arm64.zip) |
| Windows amd64 | [cub-scout_2.12.0_windows_amd64.zip](https://github.com/confighub/cub-scout/releases/download/v2.12.0/cub-scout_2.12.0_windows_amd64.zip) |

For example, on Linux amd64:

```sh
curl -fLO https://github.com/confighub/cub-scout/releases/download/v2.12.0/cub-scout_2.12.0_linux_amd64.tar.gz
curl -fLO https://github.com/confighub/cub-scout/releases/download/v2.12.0/checksums.txt
sha256sum cub-scout_2.12.0_linux_amd64.tar.gz
# Compare with the matching entry in checksums.txt before extracting.
tar -xzf cub-scout_2.12.0_linux_amd64.tar.gz
./cub-scout version
```
...
install v2.12.0. The module path does not have a `/v2` suffix: the default resolver
...
```bash
docker run ghcr.io/confighub/cub-scout:v2.12.0 version
```
...
ServiceAccount/RBAC and sink configuration; [release proof](../releases/v2.12.0.md)
...
This helper ships in v2.12.0.

### Build from Source

```bash
git clone --branch v2.12.0 --depth 1 https://github.com/confighub/cub-scout.git
cd cub-scout
go build -ldflags '-X main.BuildTag=2.12.0' -o cub-scout ./cmd/cub-scout
./cub-scout version
```
