...
The first three gaps are tracked in #584 and scheduled in stage 2 of the roadmap's
[Path to 3.0](../roadmap.md#path-to-30); that is not a committed release or date. #584 also requires shared CLI/plugin/MCP/TUI evidence, partial-access
