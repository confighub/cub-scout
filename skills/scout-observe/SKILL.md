...
phase: verify
allowed-tools: Bash(./cub-scout *) Bash(cub-scout *) Bash(cub scout *) Bash(kubectl get *) Bash(kubectl describe *) Bash(kubectl logs *) Bash(kubectl version) Bash(kubectl config current-context) Bash(kubectl config view *)
---
