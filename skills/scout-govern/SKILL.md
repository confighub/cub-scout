...
phase: verify
allowed-tools: Bash(./cub-scout history *) Bash(cub-scout history *) Bash(cub scout history *) Bash(./cub-scout impact *) Bash(cub-scout impact *) Bash(cub scout impact *) Bash(./cub-scout fleet *) Bash(cub-scout fleet *) Bash(cub scout fleet *) Bash(./cub-scout summary list *) Bash(cub-scout summary list *) Bash(cub scout summary list *) Bash(./cub-scout views resolve *) Bash(./cub-scout views project *) Bash(cub-scout views resolve *) Bash(cub-scout views project *) Bash(cub scout views resolve *) Bash(cub scout views project *) Bash(./cub-scout audit *) Bash(cub-scout audit *) Bash(cub scout audit *) Bash(./cub-scout bundle diff *) Bash(./cub-scout bundle inspect *) Bash(./cub-scout bundle summarize *) Bash(./cub-scout bundle timeline *) Bash(cub-scout bundle diff *) Bash(cub-scout bundle inspect *) Bash(cub-scout bundle summarize *) Bash(cub-scout bundle timeline *) Bash(cub scout bundle diff *) Bash(cub scout bundle inspect *) Bash(cub scout bundle summarize *) Bash(cub scout bundle timeline *) Bash(./cub-scout catalog list *) Bash(./cub-scout catalog validate *) Bash(cub-scout catalog list *) Bash(cub-scout catalog validate *) Bash(cub scout catalog list *) Bash(cub scout catalog validate *) Bash(./cub-scout status) Bash(cub-scout status) Bash(cub scout status) Bash(kubectl get *) Bash(kubectl describe *) Bash(cub space list *) Bash(cub unit get *) Bash(cub unit list *) Bash(cub link get *) Bash(cub link list *) Bash(cub view get *) Bash(cub view list *) Bash(cub unit-event list *) Bash(cub resource list *) Bash(cub release list *) Bash(cub changeset list *) Bash(cub auth status)
---
...
- **Allowed (read-only):** all eight Govern verbs; `kubectl get/describe` for cross-reference; `cub <entity> get / list` for the entities named in allowed-tools (connected); `cub auth status` to confirm mode.
