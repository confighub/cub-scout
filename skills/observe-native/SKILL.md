...
- Related skills:
  ...
  - [`observe-argocd`](../observe-argocd/SKILL.md), [`observe-flux`](../observe-flux/SKILL.md), [`observe-sveltos`](../observe-sveltos/SKILL.md), [`observe-modelplane`](../observe-modelplane/SKILL.md), [`observe-helm`](../observe-helm/SKILL.md), [`observe-crossplane`](../observe-crossplane/SKILL.md), [`observe-kro`](../observe-kro/SKILL.md), [`observe-confighub-managed`](../observe-confighub-managed/SKILL.md) — the controller categories that classify ABOVE native
