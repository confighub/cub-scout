...
func releaseCheckMCPTool() mcpTool {
	...
	properties["check_running_image"] = map[string]interface{}{"type": "boolean", "description": "Check every intended regular container's digest, running and ready status. Deployments add one bounded pod list, exact ReplicaSet owner reads and a final Deployment re-read. Mutable tags and unresolved image-index/platform digests stay UNKNOWN."}
