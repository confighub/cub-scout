...
| What image-check gaps should I know before relying on it? | [Known gaps](docs/howto/is-this-image-deployed.md#known-gaps) | Other workload types, multi-architecture resolution and image-only search remain planned. Scheduling, scale benchmarks, installation coverage and reporting limits are listed separately. |
