...
echo -e "${DIM}Press 't' in TUI or run: cub-scout trace <resource>${NC}"
echo ""
...
echo ""
echo -e "  ${CYAN}cub-scout trace deployment/nginx -n demo${NC}"
echo -e "  ${DIM}→ Trace a specific resource${NC}"
echo ""
echo -e "  ${CYAN}cub-scout trace --app frontend-app${NC}"
echo -e "  ${DIM}→ Trace an Argo CD application by name${NC}"
echo ""
echo -e "  ${CYAN}cub-scout trace deployment/nginx --json${NC}"
...
echo ""
echo -e "   ${CYAN}cub-scout trace --confighub${NC}"
echo ""
...
echo "  │ COMMANDS                                                           │"
echo "  │                                                                    │"
echo "  │  cub-scout trace <kind/name>    Trace a resource                   │"
echo "  │  cub-scout trace -n <ns> ...    Specify namespace                  │"
echo "  │  cub-scout trace --app <name>   Trace Argo CD app by name          │"
echo "  │  cub-scout trace --json         JSON output for scripting          │"
