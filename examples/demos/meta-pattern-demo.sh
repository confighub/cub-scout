...
ui_section "SAMPLE OUTPUT" "cub-scout scan --meta-patterns"
...
echo ""
echo -e "  ${CYAN}cub-scout scan --pattern state-stuck${NC}"
echo -e "  ${DIM}→ Find stuck reconciliations only${NC}"
echo ""
echo -e "  ${CYAN}cub-scout scan --pattern cross-ref${NC}"
...
echo "  │ COMMANDS                                                           │"
echo "  │                                                                    │"
echo "  │  cub-scout scan                 Full cluster scan                  │"
echo "  │  cub-scout scan --pattern <p>   Scan for specific pattern          │"
