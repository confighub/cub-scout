...
echo ""
echo -e "  +---------------------------------------------------------------------+"
echo -e "  | ${BOLD}cub-scout import -n myapp --dry-run${NC}                              |"
echo -e "  +---------------------------------------------------------------------+"
echo -e "  |                                                                     |"
...
echo ""
echo -e "  +---------------------------------------------------------------------+"
echo -e "  | ${BOLD}cub-scout import -n checkout --dry-run${NC}                           |"
echo -e "  +---------------------------------------------------------------------+"
echo -e "  |                                                                     |"
...
echo ""
echo -e "  ${CYAN}cub-scout import --dry-run${NC}"
...
echo "  | COMMANDS                                                               |"
echo "  |                                                                        |"
echo "  |  cub-scout import                    Import all namespaces             |"
echo "  |  cub-scout import -n <ns>            Import one namespace              |"
echo "  |  cub-scout import --dry-run          Preview only                      |"
echo "  |  cub-scout import --json             JSON output for GUI               |"
echo "  |  cub-scout import --no-log           Disable logging                   |"
echo "  |                                                                        |"
