...
echo -e "${DIM}Run with: cub-scout map list -q <name>${NC}"
echo ""
...
echo ""
echo -e "  ${CYAN}cub-scout map list -q gitops${NC}"
...
echo ""
echo -e "  ${CYAN}cub-scout map list -q \"deployments AND flux\"${NC}"
...
echo ""
echo -e "  ${CYAN}cub-scout map queries save my-team \"labels[team]=payments\"${NC}"
...
echo ""
echo -e "  ${CYAN}cub-scout map list -q my-team${NC}"
echo ""
echo -e "${DIM}Delete it:${NC}"
echo ""
echo -e "  ${CYAN}cub-scout map queries delete my-team${NC}"
...
ui_section "SAMPLE OUTPUT" "cub-scout map list -q unmanaged"
...
echo ""
echo -e "   ${CYAN}cub-scout map queries connect${NC}"
echo ""
echo "   → Sign up at https://confighub.com"
echo "   → Import workloads: cub-scout import --namespace <ns>"
echo "────────────────────────────────────────────────────────────────────────────"
echo ""
...
echo "  │ COMMANDS                                                           │"
echo "  │                                                                    │"
echo "  │  cub-scout map queries           List all saved queries            │"
echo "  │  cub-scout map list -q <name>    Run a saved query                 │"
echo "  │  cub-scout map queries save ...  Save a user query                 │"
echo "  │  cub-scout map queries delete .. Delete a user query               │"
echo "  │  cub-scout map queries connect   Connect to ConfigHub              │"
