...
echo -e "${DIM}Press 'c' in TUI or run: cub-scout scan${NC}"
echo ""
...
ui_section "SAMPLE OUTPUT" "cub-scout scan"
...
echo ""
echo -e "  ${DIM}List all: cub-scout scan --list${NC}"
echo ""
...
echo ""
echo -e "  ${CYAN}cub-scout scan${NC}"
echo -e "  ${DIM}→ Scan entire cluster for policy violations${NC}"
echo ""
echo -e "  ${CYAN}cub-scout scan -n production${NC}"
echo -e "  ${DIM}→ Scan specific namespace${NC}"
echo ""
echo -e "  ${CYAN}cub-scout scan --json${NC}"
echo -e "  ${DIM}→ JSON output for CI/CD integration${NC}"
echo ""
echo -e "  ${CYAN}cub-scout scan --list${NC}"
...
echo -e "  ${CYAN}cub-scout scan --json | jq -e '.summary.critical == 0'${NC}"
echo ""
echo -e "  ${DIM}# Or check specific namespace:${NC}"
echo -e "  ${CYAN}cub-scout scan -n prod --json > audit.json${NC}"
echo ""
...
echo ""
echo -e "   ${CYAN}cub-scout scan --confighub${NC}"
echo ""
...
echo "  │ COMMANDS                                                           │"
echo "  │                                                                    │"
echo "  │  cub-scout scan                 Scan cluster for violations        │"
echo "  │  cub-scout scan -n <ns>         Scan specific namespace            │"
echo "  │  cub-scout scan --json          JSON output for tooling            │"
echo "  │  cub-scout scan --list          List all KPOL policies             │"
echo "  │  cub-scout scan --verbose       Show rule details                  │"
